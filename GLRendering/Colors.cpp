...
void Colors::Execute()
{
	...
	// Shader Program
	Shader ourShader("../Shaders/Colors.vert", "../Shaders/Colors.frag");
...
void Colors::ScrollCallback(GLFWwindow* window, double xoffset, double yoffset)
{
	camera.ProcessMouseScroll(static_cast<GLfloat>(yoffset));
}

void Colors::MousePositionCallback(GLFWwindow* window, double xpos, double ypos)
{
...
void Colors::SetCallbackFunctions(GLFWwindow* window)
{
...
Colors* Colors::GLFWCallbackWrapper::s_application = nullptr;

void Colors::GLFWCallbackWrapper::MousePositionCallback(GLFWwindow* window, double xpos, double ypos)
{
	s_application->MousePositionCallback(window, xpos, ypos);
}

void Colors::GLFWCallbackWrapper::KeyboardCallback(GLFWwindow* window, int key, int scancode, int action, int mods)
{
	s_application->KeyboardCallback(window, key, scancode, action, mods);
}

void Colors::GLFWCallbackWrapper::ScrollCallback(GLFWwindow* window, double xoffset, double yoffset)
{
	s_application->ScrollCallback(window, xoffset, yoffset);
}

void Colors::GLFWCallbackWrapper::SetApplication(Colors *application)
{
