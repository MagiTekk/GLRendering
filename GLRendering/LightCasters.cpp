...
void LightCasters::Execute()
{
	...
	// Shader Program
	Shader lightingShader("Content/Shaders/LightCasters.vert", "Content/Shaders/LightCasters.frag");
...
#pragma region Rendering commands
		...
		for (GLuint i = 0; i < 10; ++i)
		{
			...
			angle = glm::radians((GLfloat)glfwGetTime() * angle);
...
void LightCasters::KeyboardCallback(GLFWwindow* window, int key, int scancode, int action, int mods)
{
...
void LightCasters::ScrollCallback(GLFWwindow* window, double xoffset, double yoffset)
{
	camera.ProcessMouseScroll(static_cast<GLfloat>(yoffset));
}

void LightCasters::MousePositionCallback(GLFWwindow* window, double xpos, double ypos)
{
...
void LightCasters::SetCallbackFunctions(GLFWwindow* window)
{
...
LightCasters* LightCasters::GLFWCallbackWrapper::s_application = nullptr;

void LightCasters::GLFWCallbackWrapper::MousePositionCallback(GLFWwindow* window, double xpos, double ypos)
{
	s_application->MousePositionCallback(window, xpos, ypos);
}

void LightCasters::GLFWCallbackWrapper::KeyboardCallback(GLFWwindow* window, int key, int scancode, int action, int mods)
{
	s_application->KeyboardCallback(window, key, scancode, action, mods);
}

void LightCasters::GLFWCallbackWrapper::ScrollCallback(GLFWwindow* window, double xoffset, double yoffset)
{
	s_application->ScrollCallback(window, xoffset, yoffset);
}

void LightCasters::GLFWCallbackWrapper::SetApplication(LightCasters *application)
{
